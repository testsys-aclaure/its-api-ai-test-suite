...
class UserAccessService {
     ...
     * @throws ApiError
     */
    static queryUserAccess(vendorId, sponsorId, programId, programInstitutionId, userId, programUserSystemId, programUserPublicId, includedUserTypes, includedUserStatuses) {
     ...
     * @throws ApiError
     */
    static deleteUserAccess(vendorId, sponsorId, programId, programInstitutionId, userId, programUserSystemId, programUserPublicId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'DELETE',
