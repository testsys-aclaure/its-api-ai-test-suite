...
exports.StartTestService = void 0;
...
class StartTestService {
     ...
     * @throws ApiError
     */
    static startTestLogin(programId, programInstitutionId, requestBody) {
     ...
     * @throws ApiError
     */
    static startTestStart(programId, programInstitutionId, requestBody) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'POST',
...
//# sourceMappingURL=StartTestService.js.map