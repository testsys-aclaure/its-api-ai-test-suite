...
class UserService {
     ...
     * @throws ApiError
     */
    static getUserQuery(vendorId, sponsorId, userId, programUserSystemId, programUserPublicId, includedUserTypes, includedUserStatuses) {
     ...
     * @throws ApiError
     */
    static deleteUserDelete(vendorId, programInstitutionId, userId, programUserSystemId, programUserPublicId) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'DELETE',
            url: '/User/delete',
            query: {
