...
class RemoteDataService {
     ...
     * @throws ApiError
     */
    static remoteAdminUrlsQuery(programId, urlType, proctorIdentifier, proctorDisplayName, proctorFirstName, proctorLastName, programInstitutionId, userId, sessionCode, redirectUrl, examineePortalOptions, groupIdentifier, limitDays, reserveNumber, reserveTime, parentSessionCode, resumeSession, minutesOffset, sessionExpiration, proctorFunctions) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            ...
            query: {
                ...
                'examinee-portal-options': examineePortalOptions,
                'group-identifier': groupIdentifier,
                'limit-days': limitDays,
                'proctor-identifier': proctorIdentifier,
                'proctor-display-name': proctorDisplayName,
                'proctor-first-name': proctorFirstName,
                'proctor-last-name': proctorLastName,
                'reserve-number': reserveNumber,
                'reserve-time': reserveTime,
                'parent-session-code': parentSessionCode,
                'resume-session': resumeSession,
                'minutes-offset': minutesOffset,
                'session-expiration': sessionExpiration,
                'proctor-functions': proctorFunctions,
            },
        });
    }
    /**
     ...
     * @throws ApiError
     */
    static remoteExamineeDataQuery(programId, programInstitutionId, sessionCode, examinee, programExamineePublicId, programExamineeSystemId, dataOptions, urlAvailableHours) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
            ...
            query: {
                ...
                'url-available-hours': urlAvailableHours,
            },
        });
    }
    /**
     ...
     * @throws ApiError
     */
    static remoteSessionDataQuery(programId, programInstitutionId, sessionCode, dataOptions, flaggedOnly, urlAvailableHours) {
        return (0, request_1.request)(OpenAPI_1.OpenAPI, {
            method: 'GET',
