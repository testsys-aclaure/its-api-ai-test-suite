...
export declare class FormService {
     ...
     * @throws ApiError
     */
    static formQuery(programId: number, programInstitutionId?: string, formId?: Array<number>, lastModifiedUtc?: string, limit?: number, beforeId?: number, afterId?: number, includeFlag?: number): CancelablePromise<Array<FormQueryByFilterAsyncResult>>;
    /**
     * /form/create
     * Creates a form.
     * @param programId The unique program identifier provided as part of configuration.
     ...
     * @throws ApiError
     */
    static formCreate(programId: number, requestBody: FormInsertAsyncRequestBody, programInstitutionId?: string): CancelablePromise<FormInsertAsyncResult>;
    /**
     * /form/update
     ...
     * @throws ApiError
     */
    static formUpdate(programId: number, requestBody: FormUpdateAsyncRequestBody, programInstitutionId?: string): CancelablePromise<FormUpdateAsyncResult>;
    /**
     * /form/delete
     ...
     * @throws ApiError
     */
    static formDelete(programId: number, formId: Array<number>, programInstitutionId?: string): CancelablePromise<Array<FormDeleteAsyncResult>>;
}
