...
export class RemoteDataService {
     ...
     * @throws ApiError
     */
    public static remoteAdminUrlsQuery(
        programId: number,
        urlType: number,
        proctorIdentifier: string,
        proctorDisplayName: string,
        proctorFirstName: string,
        proctorLastName: string,
        programInstitutionId?: string,
        userId?: number,
        sessionCode?: string,
        redirectUrl?: string,
        examineePortalOptions?: number,
        groupIdentifier?: string,
        limitDays?: number,
        reserveNumber?: number,
        reserveTime?: string,
        parentSessionCode?: string,
        resumeSession?: boolean,
        minutesOffset?: number,
        sessionExpiration?: string,
        proctorFunctions?: number,
     ...
     * @throws ApiError
     */
    public static remoteExamineeDataQuery(
        programId: number,
        programInstitutionId?: string,
        sessionCode?: string,
        ...
        dataOptions?: number,
        urlAvailableHours?: number,
    ): CancelablePromise<Array<SessionData>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static remoteSessionDataQuery(
        programId: number,
        programInstitutionId?: string,
        sessionCode?: string,
        dataOptions?: number,
