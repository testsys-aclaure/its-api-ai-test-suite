...
export class TestService {
    ...
    public static testQuery(
        ...
        afterId?: number,
        includeFlag?: number,
    ): CancelablePromise<Array<TestQueryResult>> {
    ...
    public static testCreate(
        programId: number,
        programInstitutionId?: string,
        requestBody?: TestCreateRequest,
    ): CancelablePromise<TestResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/Test/Create',
            query: {
    ...
    public static testDelete(
        ...
        testId: Array<number>,
        programInstitutionId?: string,
    ): CancelablePromise<Array<TestResponse>> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/Test/Delete',
            query: {
