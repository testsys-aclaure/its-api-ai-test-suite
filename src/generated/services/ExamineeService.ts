...
export class ExamineeService {
    ...
    public static examineeQuery(
        ...
        afterId?: number,
    ): CancelablePromise<Array<Examinee2>> {
     ...
     * @throws ApiError
     */
    public static examineeImport(
        programId: number,
        programInstitutionId?: string,
        requestBody?: ExamineeDataHolder1,
    ): CancelablePromise<Array<ExamineeResponse>> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/examinee/import',
            query: {
