...
export class ExamineeAuditService {
    /**
     ...
     * @throws ApiError
     */
    public static examineeAuditQuery(
        programId: number,
        timezoneId: number,
        ...
        endUtc?: string,
        languageCode?: string,
    ): CancelablePromise<ExamineeAuditResponse> {
     ...
     * @throws ApiError
     */
    public static examineeRecordQuery(
        programId: number,
        tableName: string,
        recordId: number,
    ): CancelablePromise<ExamineeRecordResponse> {
        return __request(OpenAPI, {
            method: 'GET',
